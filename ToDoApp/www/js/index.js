...
$$('#taskButton').on('click', function(e) {
    ...
    var res = taskDate.split("/");
    notificationTime.setMonth(res[1]);
    notificationTime.setDate(res[0]);
    notificationTime.setHours($$('#hoursInput').val());
    notificationTime.setMinutes($$('#minutesInput').val());
    notificationTime.setSeconds(1);
    var getNotification = new Date(notificationTime);
